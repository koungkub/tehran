...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/koungkub/tehran/gen/proto/greeter/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	GreeterServiceName = "proto.greeter.v1.GreeterService"
)
...
const (
	...
	GreeterServiceSayHelloProcedure = "/proto.greeter.v1.GreeterService/SayHello"
)

// GreeterServiceClient is a client for the proto.greeter.v1.GreeterService service.
type GreeterServiceClient interface {
	SayHello(context.Context, *connect.Request[v1.SayHelloRequest]) (*connect.Response[v1.SayHelloResponse], error)
}

// NewGreeterServiceClient constructs a client for the proto.greeter.v1.GreeterService service. By
...
func NewGreeterServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreeterServiceClient {
	...
	greeterServiceMethods := v1.File_proto_greeter_v1_greeter_proto.Services().ByName("GreeterService").Methods()
...
// SayHello calls proto.greeter.v1.GreeterService.SayHello.
...
// GreeterServiceHandler is an implementation of the proto.greeter.v1.GreeterService service.
...
func NewGreeterServiceHandler(svc GreeterServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/proto.greeter.v1.GreeterService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGreeterServiceHandler) SayHello(context.Context, *connect.Request[v1.SayHelloRequest]) (*connect.Response[v1.SayHelloResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.greeter.v1.GreeterService.SayHello is not implemented"))
}
